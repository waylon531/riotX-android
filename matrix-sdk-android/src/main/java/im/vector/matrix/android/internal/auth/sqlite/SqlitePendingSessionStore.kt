...
import im.vector.matrix.android.internal.db.auth.PendingSessionQueries
...
internal class SqlitePendingSessionStore @Inject constructor(database: AuthDatabase,
    ...
    override suspend fun savePendingSessionData(pendingSessionData: PendingSessionData) = withContext(coroutineDispatchers.io) {
    ...
    override suspend fun delete() = withContext(coroutineDispatchers.io) {
        pendingSessionQueries.delete()
    }
